...
const components: MDXComponents = {
  h1: (props) => <Heading as="h1" fontSize={["2xl", "2xl", "32px"]} color="white" {...props} />,
  h2: (props) => <Text fontWeight="bold" fontSize="xl" mt={12} mb={6} color="white" {...props} />,
  p: (props) => <Text my={6} color="white" fontSize="16px" lineHeight="24px" {...props} />,
  a: (props) => (
...
export const MdxLayout = (props: MdxLayoutProps) => {
  const title = `${props.meta.title} | create. Changelog`;
  const description = "Discover new updates and improvements to Create.";
  const url = "https://changelog.create.xyz";
  ...
  return (
    <MDXProvider components={components}>
      ...
      {!props.hideLayout && <Navbar mode="dark" />}
      <Timeline
