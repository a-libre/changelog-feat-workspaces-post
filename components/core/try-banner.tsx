...
interface TryCreateBannerProps extends PageSectionProps {
  subheading?: string;
...
function TryCreateBanner(props: TryCreateBannerProps) {
  const {
    heading = (
      <>
        Build a prototype{" "}
    ...
    description = (
      <>
        Use our <Highlight>autodevs</Highlight> to get started, then{" "}
        <Highlight as="a" href="https://www.create.xyz/upgrade">
          upgrade
        </Highlight>{" "}
        to instantly get a <Highlight>vetted (human) dev team</Highlight> to build the rest fast
        with code generation
      </>
    ),
    buttonText = "Get started for free",
    buttonHref = "https://create.xyz",
...
export default TryCreateBanner;
